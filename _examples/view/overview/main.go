...
In case you're wondering, the code behind the view engines derives from the "github.com/8treenet/iris/v12/view" package,
access to the engines' variables can be granded by "github.com/8treenet/iris/v12" package too.
